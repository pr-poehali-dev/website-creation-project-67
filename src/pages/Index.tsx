      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center space-y-8 animate-fade-in">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl mx-auto animate-scale-in" style={{ animationDelay: '0.4s' }}>
            <Button 
              size="lg" 
              className="bg-gradient-to-br from-[#0088cc] to-[#229ED9] hover:shadow-2xl hover:scale-110 transition-all duration-300 text-lg py-12 w-full rounded-full flex items-center justify-center gap-3 border-2 border-white/20"
              onClick={() => window.open('https://t.me/kwiqsy', '_blank')}
            >
            ...
            <Button 
              size="lg" 
              className="bg-gradient-to-br from-[#000000] to-[#fe2c55] hover:shadow-2xl hover:scale-110 transition-all duration-300 text-lg py-12 w-full rounded-full text-white flex items-center justify-center gap-3 border-2 border-white/20"
            ...
            <Button 
              size="lg" 
              className="bg-gradient-to-br from-[#0077FF] to-[#4A9EFF] hover:shadow-2xl hover:scale-110 transition-all duration-300 text-lg py-12 w-full rounded-full text-white flex items-center justify-center gap-3 border-2 border-white/20"
